...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "configGenerator", function () {
      ...
      var config = pokemon.map(function (pokemon) {
        var element = external_react_default.a.createElement("div", null, "'/pokemon/".concat(pokemon.name, "': { page: '/pokemon', query: { id: ").concat(pokemon.id, " }}"));
        return element;
      });
      console.log(config);
      return config;
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      }), external_react_default.a.createElement("br", null), external_react_default.a.createElement("div", null, this.configGenerator()));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
