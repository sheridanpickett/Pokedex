    ...
    value: function render() {
      ...
      if (!pokemon.name) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_MyLayout_js__WEBPACK_IMPORTED_MODULE_5__["default"], {
          ...
          __self: this
        }, Math.floor(pokemon.stats[0].base_stat / 10), Math.floor(pokemon.stats[1].base_stat / 10), Math.floor(pokemon.stats[2].base_stat / 10), Math.floor(pokemon.stats[3].base_stat / 10), Math.floor(pokemon.stats[4].base_stat / 10), Math.floor(pokemon.stats[5].base_stat / 10)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 113
          },
...
//# sourceMappingURL=pokemon.js.a5aa29359ef897686f33.hot-update.js.map